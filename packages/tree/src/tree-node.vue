    ...
    >
      <span
        :class="[
          ...
          'tj-tree-node__expand-icon',
          tree.props.iconClass ? tree.props.iconClass : 'tj-icon-caret-right',
        ]"
      ...
      <span
        v-if="node.loading"
        class="tj-tree-node__loading-icon tj-icon-loading"
      >
      </span>
