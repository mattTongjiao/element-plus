<template>
  <div
    class="tj-picker-panel tj-date-range-picker"
    :class="[
      {
  ...
  >
    <div class="tj-picker-panel__body-wrapper">
      <slot name="sidebar" class="tj-picker-panel__sidebar"></slot>
      <div v-if="hasShortcuts" class="tj-picker-panel__sidebar">
        <button
          v-for="(shortcut, key) in shortcuts"
          :key="key"
          type="button"
          class="tj-picker-panel__shortcut"
          @click="handleShortcutClick(shortcut)"
        >
          {{ shortcut.text }}
        </button>
      </div>
      <div class="tj-picker-panel__body">
        <div v-if="showTime" class="tj-date-range-picker__time-header">
          <span class="tj-date-range-picker__editors-wrap">
            <span class="tj-date-range-picker__time-picker-wrap">
              <tj-input
                size="small"
            ...
            <span
              ...
              class="tj-date-range-picker__time-picker-wrap"
            >
              <tj-input
                size="small"
                class="tj-date-range-picker__editor"
          ...
          <span class="tj-icon-arrow-right"></span>
          <span class="tj-date-range-picker__editors-wrap is-right">
            <span class="tj-date-range-picker__time-picker-wrap">
              <tj-input
                size="small"
                class="tj-date-range-picker__editor"
        ...
        <div
          class="tj-picker-panel__content tj-date-range-picker__content is-left"
        >
          <div class="tj-date-range-picker__header">
            <button
              type="button"
              class="tj-picker-panel__icon-btn tj-icon-d-arrow-left"
              @click="leftPrevYear"
            ></button>
            <button
              type="button"
              class="tj-picker-panel__icon-btn tj-icon-arrow-left"
              @click="leftPrevMonth"
            ></button>
            <button
              v-if="unlinkPanels"
              ...
              class="tj-picker-panel__icon-btn tj-icon-d-arrow-right"
              @click="leftNextYear"
            ></button>
            <button
              v-if="unlinkPanels"
              ...
              class="tj-picker-panel__icon-btn tj-icon-arrow-right"
              @click="leftNextMonth"
            ></button>
            <div>{{ leftLabel }}</div>
          </div>
        ...
        <div
          class="tj-picker-panel__content tj-date-range-picker__content is-right"
        >
          <div class="tj-date-range-picker__header">
            <button
              v-if="unlinkPanels"
    ...
    <div v-if="showTime" class="tj-picker-panel__footer">
      <tj-button
        size="mini"
        type="text"
        class="tj-picker-panel__link-btn"
        @click="handleClear"
      >
...
export default defineComponent({
  ...
  components: { TimePickPanel, DateTable, TjInput, TjButton },
