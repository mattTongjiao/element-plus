...
| low-threshold            | valor del umbral entre nivel bajo y medio. Tj valor será incluido en el nivel bajo                                                                                                                                                                                             | number       | —                | 2                                                        |
| high-threshold           | valor del umbral entre nivel bajo y medio. Tj valor será incluido en el nivel alto                                                                                                                                                                                             | number       | —                | 4                                                        |
...
| icon-classes             | nombres de clase de los iconos. Si es array, debe tener 3 elementos, cada uno de los cuales corresponde a un nivel de puntuación, en caso contrario, si es objeto, la clave debe ser el valor umbral entre dos niveles, y el valor debe ser la clase de icono correspondiente. | array/object | —                | ['tj-icon-star-on', 'tj-icon-star-on','tj-icon-star-on'] |
| void-icon-class          | nombre de clase para iconos no seleccionados                                                                                                                                                                                                                                   | string       | —                | tj-icon-star-off                                         |
| disabled-void-icon-class | nombre de clase para elementos no seleccionados de solo lectura                                                                                                                                                                                                                | string       | —                | tj-icon-star-on                                          |
