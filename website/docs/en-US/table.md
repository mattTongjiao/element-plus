...
:::demo By setting the attribute `max-height` of `tj-table`, you can fix the table header. The table body scrolls only if the height of the rows exceeds the max height value.
