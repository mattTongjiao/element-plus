...
<tj-upload
  ...
  :file-list="fileList"
>
  <tj-button size="small" type="primary">点击上传</tj-button>
  <template #tip>
    <div class="tj-upload__tip">只能上传 jpg/png 文件，且不超过 500kb</div>
  </template>
</tj-upload>
<script>
  export default {
...
>
  ...
  <div class="tj-upload__text">将文件拖到此处，或<em>点击上传</em></div>
  <template #tip>
    <div class="tj-upload__tip">
      只能上传 jpg/png 文件，且不超过 500kb
    </div>
...
>
  <template #trigger>
    <tj-button size="small" type="primary">选取文件</tj-button>
  </template>
  <tj-button
