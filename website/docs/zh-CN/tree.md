...
<div class="buttons">
  <tj-button @click="getCheckedNodes">通过 node 获取</tj-button>
  <tj-button @click="getCheckedKeys">通过 key 获取</tj-button>
  <tj-button @click="setCheckedNodes">通过 node 设置</tj-button>
  <tj-button @click="setCheckedKeys">通过 key 设置</tj-button>
  <tj-button @click="resetChecked">清空</tj-button>
</div>
...
```html
<tj-input placeholder="输入关键字进行过滤" v-model="filterText"> </tj-input>
